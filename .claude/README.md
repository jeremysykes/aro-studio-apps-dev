...
**[governance/agents.md](governance/agents.md)** (orchestration) is the single source of truth for:
...
Agent definitions under [agents/](agents/) extend that contract with layer-specific docs and checklists. They do not replace the orchestration doc.

## How to use

1. **Choose an agent:** Use [governance/routing.md](governance/routing.md) to map your task to an agent (or sequence of agents per execution order in [governance/agents.md](governance/agents.md)).
...
- **New agent:** Add an entry and section in [governance/agents.md](governance/agents.md), then add `agents/<name>/AGENT.md` and list it in [agents/README.md](agents/README.md) and [governance/routing.md](governance/routing.md).
