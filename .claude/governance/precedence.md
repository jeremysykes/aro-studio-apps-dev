...
2. **Agents** — [../agents/](../agents/): each agent's AGENT.md defines identity, scope, and domain guidance. Root [AGENTS.md](../../AGENTS.md) is the canonical contract (responsibilities, "must not", execution order).
