...
Use this mapping to choose which agent(s) should handle a request. The canonical list of agents and their responsibilities is in root [AGENTS.md](../../AGENTS.md). Agent definitions (behavior and domain docs) are under [../agents/](../agents/).
