...
**To run an agent:** Use the agent definitions under [../agents/](../agents/). Each agent has a single `AGENT.md` file with identity, scope, and domain guidance. Canonical authority for who may do what is [governance/agents.md](../governance/agents.md). Routing (which agent for which task) is in [../governance/routing.md](../governance/routing.md).
