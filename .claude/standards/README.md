...
- **[.cursor/rules/](../../.cursor/rules/)** — Cursor rules applied when working in this repo. [CURSOR_RULES.md](../../.cursor/rules/CURSOR_RULES.md) holds the ruleset (Core, Desktop, Web, Modules, Product Designer, UI Engineer). [README.md](../../.cursor/rules/README.md) points to root AGENTS.md and docs. Rules must be consistent with `docs/` and with [AGENTS.md](../../AGENTS.md).
