...
For **agent role boundaries and execution order** (which agent may do what in the dev repo), see [.claude/governance/agents.md](../../.claude/governance/agents.md). Agent definitions and control plane: [.claude/](../../.claude/).
