# Module Model A (Multi-Variant) for MVP

**Date:** 2025-02-09  
**Title:** Module Model A (Multi-Variant) for MVP

## Summary

Start with Model A: one module per app; module owns the UI; build/config selects the active module. Model B (Dashboard) is documented for future transition.
