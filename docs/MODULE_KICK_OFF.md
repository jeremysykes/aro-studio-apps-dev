...
- [DESKTOP_PUBLIC_API.md](DESKTOP_PUBLIC_API.md)
- [CORE_PUBLIC_API.md](CORE_PUBLIC_API.md)
...
See [docs/MODULE_MODELS.md](MODULE_MODELS.md) for the full Model A vs Model B comparison.
...
- **Build/config selects active module** — one module loaded at a time
...
- See [docs/MODULE_B_TRANSITION.md](MODULE_B_TRANSITION.md) for the transition path
...
1. [docs/MODULE_MODELS.md](MODULE_MODELS.md) — Model A vs Model B comparison
2. [docs/MODULE_B_TRANSITION.md](MODULE_B_TRANSITION.md) — Future path to Dashboard
3. [docs/MODULE_ARCHITECTURE.md](MODULE_ARCHITECTURE.md) — Module responsibilities, flow, boundaries
4. [docs/MODULE_CONSTRAINTS.md](MODULE_CONSTRAINTS.md) — Constraint implementation details
5. [docs/MODULE_PUBLIC_API.md](MODULE_PUBLIC_API.md) — Job registration, IPC surface
6. [docs/MODULE_MVP_CHECKLIST.md](MODULE_MVP_CHECKLIST.md) — Pass/fail for hello-world module
...
- See [docs/MODULE_CONSTRAINTS.md](MODULE_CONSTRAINTS.md) for implementation details
