...
- Reference from docs or ADRs using Obsidian transclusion: `![[diagrams/filename]]` (no extension). This embeds and renders the diagram when viewing in Obsidian. For non-Obsidian viewers, add a fallback link; from a doc in a subdir use `[diagrams/filename.md](../../diagrams/filename.md)`.
